...
type LayoutRouteId = RouteId | "/" | "/403" | "/404" | "/500" | "/[nickname]" | "/article/[slug]" | "/articles" | "/dashboard-01" | "/donate" | "/donation" | "/donations" | "/giris" | "/kayit" | "/login" | "/moderation" | "/register" | "/sidebar-13" | "/write" | null
type LayoutParams = RouteParams & { nickname?: string; slug?: string }
