  ...
  try {
    ...
    const payloadArticles = articleDocs.map((article: any) => {
      ...
      console.log('Article author data:', {
        ...
        author_surname: article.author_surname
      });
      ...
      return {
        ...
        author: {
          ...
          nickname: article.author_nickname || article.author_name, // nickname yoksa username kullan
          username: article.author_name, // This is the username from users table
