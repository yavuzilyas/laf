<script lang="ts">
    ...
    let profileData = $state({
        ...
        username: profileUser?.username || profileUser?.nickname || "",
        bio: profileUser?.bio || "",
...
<svelte:head>
    <title>@{profileUser?.username || profileUser?.nickname} - LAF</title>
    <meta name="description" content={profileUser?.bio || `${profileUser?.username || profileUser?.nickname}'s profile on LAF`} />
</svelte:head>
    ...
    <div class="container mx-auto px-3 py-4 sm:px-4 sm:py-8 max-w-6xl">
        ...
        <Card>
            <CardHeader class="space-y-2">
                ...
                <CardDescription>
                    {isOwnProfile ? t('profile.myArticlesDescription') : `@${profileUser?.username || profileUser?.nickname}'s articles`}
                </CardDescription>
            </CardHeader>
