        ...
        <div class="relative">
          <Avatar class="h-21 w-21 sm:h-32 sm:w-32 rounded-full border-background shadow-lg transition-all duration-300 ease-in-out {isEditing ? 'scale-110 shadow-xl' : 'scale-100 hover:scale-105'}">
            ...
            <AvatarFallback class="text-3xl">
              {(profileData?.username || profileUser?.username || profileUser?.nickname || 'U')[0].toUpperCase()}
            </AvatarFallback>
          </Avatar>
        ...
        <div>
          <div class="flex items-center gap-1">
            <h1 class="text-lg font-bold text-foreground">
              {profileData?.name || profileData?.username || profileUser?.username || profileUser?.nickname}
            </h1>
            {#if showProfileLink && (profileData?.username || profileUser?.username || profileUser?.nickname)}
              <a 
                href={`/${profileData?.username || profileUser?.username || profileUser?.nickname}`}
          ...
          <p class="text-muted-foreground">@{profileUser?.username || profileUser?.nickname} </p>
        </div>
            ...
            <li class="flex items-center justify-between gap-3 rounded-lg border p-3">
              <div class="flex max-w-[calc(100%-4rem)] items-center gap-3 flex-1">
                ...
                <Avatar class="h-10 w-10">
                  ...
                  {/if}
                  <AvatarFallback>
                    {(follower?.username || follower?.nickname || 'U')[0].toUpperCase()}
                  </AvatarFallback>
                </Avatar>
                </a>
                <div class="flex flex-col text-sm flex-1">
                  <a href={`/${follower.username}`} class="font-semibold text-foreground hover:text-primary transition-colors">{follower?.username || follower?.nickname}</a>
