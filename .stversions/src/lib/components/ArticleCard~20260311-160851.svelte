      ...
      <div class="mt-6 flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div class="flex items-center gap-2">
            <A href={`/${article.author_nickname || article.author?.username || article.authorId}`} class="flex items-center gap-2 hover:opacity-80 transition-opacity">
              ...
              <div class="text-sm">
                ...
                <p class="text-xs text-muted-foreground">@{article.author_nickname || article.author?.username || article.authorId}</p>
              </div>
            </A>
