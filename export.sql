...
\restrict lGXE6dko0s19DExXKK6M248MvgDvduhbFKhjAu7ag4fq20IOI7bojolzELRGIc4
...
--
-- Name: qr_entries; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: qr_entries qr_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.qr_entries
    ADD CONSTRAINT qr_entries_pkey PRIMARY KEY (id);
...
--
-- Name: idx_qr_entries_entry_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_qr_entries_entry_time ON public.qr_entries USING btree (entry_time);


--
-- Name: idx_qr_entries_source_url; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_qr_entries_source_url ON public.qr_entries USING btree (source_url);


--
-- Name: idx_qr_entries_time_url; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_qr_entries_time_url ON public.qr_entries USING btree (entry_time, source_url);


--
-- Name: idx_qr_entries_username; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_qr_entries_username ON public.qr_entries USING btree (username);
...
--
-- Name: events events_note_added_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.events
    ADD CONSTRAINT events_note_added_by_fkey FOREIGN KEY (note_added_by) REFERENCES public.users(id) ON DELETE SET NULL;
...
\unrestrict lGXE6dko0s19DExXKK6M248MvgDvduhbFKhjAu7ag4fq20IOI7bojolzELRGIc4
